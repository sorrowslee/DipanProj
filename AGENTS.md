...
| 放/改 NPC、NPC 對話/開介面、未來護送/陣營 | [readme/NPC_SYSTEM.md](readme/NPC_SYSTEM.md)（NpcTable 分表、圖沿用 Monsters/SequenceImage 角色圖庫、「誰能傷誰」只改 `FactionRelations.cs`；編輯器與主遊戲的 NpcInstance 是鏡像） |
