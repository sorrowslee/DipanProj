...
**集氣 × 連擊**（2026-08-26）：配方同時填 `ChargeMode=1` 與 `BurstCount>1` 時，放開的那串連擊**整串都是 ×3 的集氣彈**（第一發拿到的是 ×3 快照，後面幾發沿用同一份）。連擊進行中集氣輸入不會被讀。見 [RECIPE_DESCRIBE.md](RECIPE_DESCRIBE.md) §3.13。
