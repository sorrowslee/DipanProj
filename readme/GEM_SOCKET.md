...
**不要再直接讀 `data.Icon`** ——那個地方的珠子會變成一顆看不出是什麼能力的空白珠子，
**血統藥劑會變成一個看不出是哪個系列第幾階的空瓶**（2026-09-13 起血統也是疊圖，見 [BLOODLINE.md](BLOODLINE.md) §3），而且不會報錯。
...
| 9~27 | 綿延／遠射／廣角／群環／環距／頻擊／連鎖／引雷／鎖敵／吸落／群召／眾生／廣刃／長驅／聚氣／省魔／粗束／連擊／平行（2026-08-26 第二批） | **暫借**上面八個 key | ⏳ 外型待重製，見 TODO |
