...
| `Atmosphere` | 1~11 | **氛圍後處理**。`1` 正常；`2` 幽暗+打光；`3` 噩夢+打光；`4` 烈日曝曬；`5` 焦土餘燼；`6` 沙塵暴（4/5/6 末日炎熱系、帶熱浪）；`7` 淺海；`8` 深海；`9` 深海+恐怖（7/8/9 海洋系、帶水下折射）；`10` 風雪；`11` 強風（10/11 山頂風系）。**留空 / 缺欄 = 預設 1。** 換地圖即時切換，所以可「室外白天 → 傳送 → 古墓變陰森」。詳見 [ATMOSPHERE.md](ATMOSPHERE.md)。 |
