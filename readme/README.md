...
| [INTRO_COMIC.md](INTRO_COMIC.md) | 序章韓漫式開場漫畫播放器（獨立 Intro 場景、全程式建構、`IntroComicController`）：白框 runtime 裁切只露重點、空白鍵讓分鏡從不同方向滑入並累積、叢集換氣清空、09~11 全篇幅計時特寫，播完接墜落動畫。排版/裁切/方向全資料驅動 | 改開場漫畫、調每格擺放/露出裁切/滑入方向/叢集分組/全篇幅節奏 |
